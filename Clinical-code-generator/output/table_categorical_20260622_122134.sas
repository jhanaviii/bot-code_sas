...
proc freq data=work.analysis noprint;
    tables TRTA * AVALC / cmh chisq fisher outpct out=work.freq_counts;
...
title1 "Table X.X.X";
title2 "Summary of Categorical Endpoints";
...
/*
REVIEWER NOTES:
1. This program generates table output for categorical analysis
