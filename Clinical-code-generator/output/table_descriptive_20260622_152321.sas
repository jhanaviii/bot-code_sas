...
* DATE CREATED  : 22Jun2026
* DATE MODIFIED : 22Jun2026
*
* REGULATORY    : 
* SUBMISSION    : 
*
...
* ---------   ----------    ------------------------------------------------
* 22Jun2026  [Name]        Initial creation
******************************************************************************/
...
ods pdf text="~S={just=center font_weight=bold font_size=10pt}
";
ods pdf text="~S={just=center font_size=9pt}
Protocol: ";
ods pdf text="~S={just=center font_size=9pt}
Population:  Population";

title1 "Table X.X.X";
title2 "Summary of Descriptive Statistics";
title3 " Population";

footnote1 "Source: adsl";
footnote2 "Program: &progname..sas  Output: &outname..pdf";
...
/*
REVIEWER NOTES:
1. This program generates table output for descriptive analysis
