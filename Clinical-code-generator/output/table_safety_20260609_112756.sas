...
* DATE CREATED  : 09Jun2026
* DATE MODIFIED : 09Jun2026
*
* REGULATORY    : FDA
* SUBMISSION    : NDA
*
...
* ---------   ----------    ------------------------------------------------
* 09Jun2026  [Name]        Initial creation
******************************************************************************/
...
proc sql;
    ...
    select TRTA, trtn, AEBODSYS, AEDECOD,
           count(distinct USUBJID) as n_subj,
           count(*) as n_events
    from work.adae
    group by TRTA, trtn, AEBODSYS, AEDECOD
...
/*
REVIEWER NOTES:
1. This program generates table output for safety analysis
