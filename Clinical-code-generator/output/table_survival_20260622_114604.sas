...
proc phreg data=work.analysis;
    ...
    model AVAL * CNSR(1) = TRTA / ties=efron rl alpha=&alpha;
    hazardratio TRTA / diff=ref cl=wald;
...
title1 "Table X.X.X";
title2 "Summary of Time-to-Event Analysis";
...
/*
REVIEWER NOTES:
1. This program generates table output for survival analysis
